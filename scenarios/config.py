...
TAMPERED_IMPUT_SENSOR_CONFIGS = [
    ...
    {
        "params": {"T_0": 100, "nHat_B": [0, 1, 0]},  # Tampered Initial Temperature and Orientation
        "description": "Tampered Initial Temperature and Orientation"
    },
    {
        "params": {"T_0": 100, "sensorPowerDraw": 100.0},  # Tampered Initial Temperature and Power Draw
        "description": "Tampered Initial Temperature and Power Draw"
    },
    {
        "params": {"nHat_B": [0, 1, 0], "sensorPowerDraw": 100.0},  # Tampered Orientation and Power Draw
        "description": "Tampered Orientation and Power Draw"
    },
    {
        "params": {"T_0": 100, "nHat_B": [0, 1, 0], "sensorPowerDraw": 100.0},  # Tampered All Three
